    ...
    <div class="container-fluid">
        <div class="ml-5 inline col-lg-6">
            ...
            <div class="bg-light p-30 mb-5">
                <form method="POST" action="{{url(URL::current() . '/send-request-money')}}" enctype="multipart/form-data" class="form-group">
                    @csrf
                    ...
                    <label style="color: darkgreen;" for="amount">Amount Needed:</label><br />
                    ...
                    <div class="pt-2">
                        <button class="btn btn-primary font-weight-bold py-2">Send Request</button>
                    </div>
                </form>
            </div>
        </div>
