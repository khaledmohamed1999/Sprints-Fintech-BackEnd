    ...
    <div class="container-fluid">
        <div class="ml-5 inline col-lg-6">
            ...
            <div class="bg-light p-30 mb-5">
                <img class="p-4 mr-auto" height="184" src="{{url('storage/'.$vendor->image_url)}}" alt="">
                <form method="POST" action="{{url('send-money' . '/send-money-request')}}" enctype="multipart/form-data" class="form-group">
                    @csrf
                    <input hidden class="form-control" type="text" id="email" name="email" value="{{$userVendor->email}}" /><br />
